...
class EmbeddedFineTuner:
    ...
    def formatting_prompts_func(self, examples: Dict) -> Dict:
        ...
        for conv in conversations:
            try:
                formatted_text = self.create_embedded_training_prompt(conv)
    ...
    def prepare_dataset(self) -> Dataset:
        ...
        dataset = dataset.map(parse_conversations, num_proc=4)
...
def main():
    ...
    config = EmbeddedTrainingConfig(
        ...
        # Dataset
        dataset_name="mrkswe/llmEndpointDatasetConversation_2",

        # Output settings
        output_dir="./embedded_outputs",
        hub_model_id="mrkswe/EndpointSelector",  # Your model name
        hf_token="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",
